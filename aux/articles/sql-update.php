...
$res = $db->prepare("UPDATE `Articles` 
    SET Name=:name, Description=:description, Transmission=:transmission, Category=:category, Subcategory=:subcategory, PhotoURL=:photo, Weight=:weight, Channel=:channel, Price=:price, Quantity=:quantity
    WHERE
    id=".$id);
