skuDialog =
    ...
    init: ->
        ...
        $("#add-sku").click ->
            ...
            item =
                "<div id=\"" + itemId + "\" class=\"shelf-item\">" + respond.defaults.elementMenuShelf +
                ...
                "<div class=\"shelf-group3\">" +
                    "<span class=\"shelf-add\"><button class=\"btn btn-default\"><i class=\"fa fa-shopping-cart\"></i> <span>In den Waaaaarenkorb</span></button></span>" +
                "</div></div>"
