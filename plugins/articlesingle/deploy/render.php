...
<table id="articles" class="table table-striped table-hover table-condensed table-price-cart">
  <thead>
    <tr>
      <th>Name</th>
      <th>Preis *</th>
...
<?php
  print("<tr class='shelf-item'>");
    ...
    print("<td><span class='shelf-duration' style='display:none;'><input type='number' value='1'></span><span class='shelf-add'><button class='btn btn-default'><i class='fa fa-shopping-cart'></i></button></span></td>");
  print("</tr>");
?>
  </tbody>
</table>
