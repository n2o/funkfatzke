	...
	<nav class="navbar navbar-default" role="navigation">
	  ...
	  <div class="collapse navbar-collapse navbar-ex1-collapse">
	    <ul class="nav navbar-nav navbar-right">
			<li><a href="../index">Home</a></li><li><a href="../artikel/handfunkgeraete">Handfunkgeräte</a></li><li><a href="../artikel/test">test</a></li><li><a href="../blog">Blog</a></li><li><a href="../page/about">About</a></li><li class="active"><a href="../page/contact">Contact</a></li>
...
<div id="content" class="container" role="main">
	...
	<div class="col col-md-12">
		<h1 id="h1-1"><?php print _("Contact Us"); ?></h1>
		<p id="paragraph-1"><?php print _("Placeholder for the Contact Us page."); ?></p>
