...
<title>Funkfatzke</title>
<meta name="description" content="<?php print _("Welcome to your new homepage created with Respond CMS"); ?>">
...
<div id="content" class="container" role="main">
	<div id="block-1" class="block row container-white" data-nested="not-nested" data-containerid="" data-containercssclass=""><div class="col col-md-12"><h1 id="h1-2"><?php print _("Welcome to Respond!"); ?></h1><p id="paragraph-2"><?php print _("This is the starter theme for <a href=\"http://respondcms.com\">Respond</a>. Respond is a responsive content management system that you can use to build responsive websites. Use it as a starting point to create your own site."); ?></p></div></div><div id="block-2" class="block row container-white" data-nested="not-nested" data-containerid="" data-containercssclass=""><div class="col col-md-4"><h2 id="h2-2"><?php print _("Subheading 1"); ?></h2><p id="paragraph-3"><?php print _("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec venenatis mollis arcu, eget posuere libero faucibus sit amet. Cras pharetra pellentesque augue, id vestibulum nisi pharetra et. Morbi in dapibus leo. Vivamus vehicula risus vel eros interdum et mattis tortor congue. Sed gravida interdum est, sit amet pretium nisl consectetur at. In hac habitasse platea dictumst. In purus enim, elementum porttitor tincidunt volutpat, fermentum quis ante. Vivamus at est sem, quis ornare lorem. Cras pulvinar est eget nisi iaculis consequat."); ?></p><p id="1345990334"><?php print _("Vestibulum lacinia, sem vitae cursus imperdiet, diam diam aliquet nunc, et hendrerit dui mauris ut lacus. Curabitur eget dolor enim, sit amet hendrerit lacus. Phasellus ornare enim ipsum, eu ullamcorper dolor. Morbi in purus sit amet eros fringilla vestibulum quis in nisi. Vivamus diam metus, viverra vel aliquam id, pretium a urna. Phasellus blandit eleifend ligula, sit amet adipiscing est pretium ut. Curabitur nibh quam, adipiscing nec pretium non, dictum in tellus. Vivamus vel posuere elit."); ?></p></div><div class="col col-md-4"><h2 id="h2-3"><?php print _("Subheading 2"); ?></h2><p id="paragraph-4"><?php print _("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec venenatis mollis arcu, eget posuere libero faucibus sit amet. Cras pharetra pellentesque augue, id vestibulum nisi pharetra et. Morbi in dapibus leo. Vivamus vehicula risus vel eros interdum et mattis tortor congue. Sed gravida interdum est, sit amet pretium nisl consectetur at. In hac habitasse platea dictumst. In purus enim, elementum porttitor tincidunt volutpat, fermentum quis ante. Vivamus at est sem, quis ornare lorem. Cras pulvinar est eget nisi iaculis consequat."); ?></p><p id="1345990334"><?php print _("Vestibulum lacinia, sem vitae cursus imperdiet, diam diam aliquet nunc, et hendrerit dui mauris ut lacus. Curabitur eget dolor enim, sit amet hendrerit lacus. Phasellus ornare enim ipsum, eu ullamcorper dolor. Morbi in purus sit amet eros fringilla vestibulum quis in nisi. Vivamus diam metus, viverra vel aliquam id, pretium a urna. Phasellus blandit eleifend ligula, sit amet adipiscing est pretium ut. Curabitur nibh quam, adipiscing nec pretium non, dictum in tellus. Vivamus vel posuere elit."); ?></p></div><div class="col col-md-4"><h2 id="h2-4"><?php print _("Subheading 3"); ?></h2><p id="paragraph-5"><?php print _("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec venenatis mollis arcu, eget posuere libero faucibus sit amet. Cras pharetra pellentesque augue, id vestibulum nisi pharetra et. Morbi in dapibus leo. Vivamus vehicula risus vel eros interdum et mattis tortor congue. Sed gravida interdum est, sit amet pretium nisl consectetur at. In hac habitasse platea dictumst. In purus enim, elementum porttitor tincidunt volutpat, fermentum quis ante. Vivamus at est sem, quis ornare lorem. Cras pulvinar est eget nisi iaculis consequat."); ?></p><p id="1345990334"><?php print _("Vestibulum lacinia, sem vitae cursus imperdiet, diam diam aliquet nunc, et hendrerit dui mauris ut lacus. Curabitur eget dolor enim, sit amet hendrerit lacus. Phasellus ornare enim ipsum, eu ullamcorper dolor. Morbi in purus sit amet eros fringilla vestibulum quis in nisi. Vivamus diam metus, viverra vel aliquam id, pretium a urna. Phasellus blandit eleifend ligula, sit amet adipiscing est pretium ut. Curabitur nibh quam, adipiscing nec pretium non, dictum in tellus. Vivamus vel posuere elit."); ?></p></div></div>
</div>
